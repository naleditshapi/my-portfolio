  ...
  return (
    <section id="contact" className="py-28 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-16">
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-gray-400 mb-4">Get In Touch</p>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2" htmlFor="name">Name</label>
                    <input id="name" name="name" type="text" required value={form.name} onChange={handleChange}
                      placeholder="Jane Smith" className={inputClass} />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2" htmlFor="email">Email</label>
                    <input id="email" name="email" type="email" required value={form.email} onChange={handleChange}
                      placeholder="jane@company.com" className={inputClass} />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2" htmlFor="message">Message</label>
          ...
          <div className="lg:w-72 space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-xs text-gray-400 font-medium mb-0.5">Availability</p>
