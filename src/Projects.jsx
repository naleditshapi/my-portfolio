...
function ProjectCard({ project }) {
  return (
    <div className="group bg-white rounded-2xl p-7 hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-transparent flex flex-col">
      ...
      <div className="flex flex-wrap gap-1.5 mb-5">
        {project.tech.map((t) => (
          <span key={t} className="bg-gray-50 text-gray-500 text-xs px-2.5 py-1 rounded-lg font-mono border border-gray-100">
            {t}
          </span>
        ))}
      </div>
    ...
    <section id="projects" className="py-28 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          <div>
            <p className="text-xs font-semibold tracking-[0.2em] uppercase text-gray-400 mb-4">What I've Built</p>
